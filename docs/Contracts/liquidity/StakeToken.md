...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | struct IRate.Rate | Staking fee rate. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | uint256 | Total supply of the token. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | uint256 | Stake of the account. |
...
_The contract secures primary tokens and mints the exact amount of stake tokens to the staker._
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | uint256 | Updated interest accumulation rate. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | uint256 | Converted weight value. |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| [0] | uint256 | Converted token balance. |
